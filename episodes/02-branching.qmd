...
flowchart TD
  ...
  subgraph subGraph1["<div style=margin-top: 1em>Computer 3</div>"]
    r2[("Local Repository")]
  end
  subgraph subGraph2["<div style=margin-top: 10em>Computer 2</div>"]
    r3[(" Local Repository")]
  end
  subgraph subGraph3["<div style=margin-top: 5em>Computer 1</div>"]
    r4[("Local Repository")]
  end
